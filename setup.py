...
def get_version():
    with open('pytgvoip_telethon/__init__.py', encoding='utf-8') as f:
...
setup(
    name='pytgvoip_telethon',
    version=get_version(),
    license='LGPLv3+',
    author='chenqi',
    author_email='c1311949161@gmail.com',
    description='Telethon support module for Telegram VoIP Library for Python',
